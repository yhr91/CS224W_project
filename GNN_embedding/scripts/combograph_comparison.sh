...
python3 train.py --network-type GEO_GCN --dataset Decagon_GNBR --use-features --MTL --epochs 2000 --score loss_sum --hidden-dim 36 --shuffle --sample-diseases --edge-attr 2 --expt_name graphcombo_compare_multi_edge_
